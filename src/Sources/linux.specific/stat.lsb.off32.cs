...
namespace Tmds.Linux
{
    public static unsafe partial class LibC
    {
        ...
        [DllImport(libc, SetLastError = true, EntryPoint="__lxstat64")]
        private static extern int _lstat(int ver, byte* path, stat * stat);
        [DllImport(libc, SetLastError = true, EntryPoint="__fxstatat64")]
        private static extern int _fstatat (int ver, int fd, byte* path, stat* stat, int flags);
        [DllImport(libc, SetLastError = true, EntryPoint="__fxstat64")]
